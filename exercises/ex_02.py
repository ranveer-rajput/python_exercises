...
# Instructions
Write a function called `find_numbers(min, max)` to find all numbers which are 
divisible by 7 but are not multiples of 5, between the given range of `min` and 
`max` (both included). Return a list of these numbers.
